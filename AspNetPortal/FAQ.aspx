<%@ Page Title="Frequently Asked Questions" Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FAQ.aspx.vb" Inherits="AspNetPortal._FAQ" %>
        ...
        <tr>
          <td bgcolor="black">
            <table border="0" width="100%" cellspacing="1" cellpadding="20">
              <tr>
                <td bgcolor="black"><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Table of Contents</b></font></td>
              </tr>
              <tr>
                ...
                <li><span class="spnMessageText"><a href="#popups">Do I have to enable Popup Windows?</a></span></li>
                <li><span class="spnMessageText"><a href="#smilies">How can I use smilies and images?</a></span></li>
                <li><span class="spnMessageText"><a href="#hyperlink">Can I add a hyperlink to my ads and messages?</a></span></li>
                ...
                <li><span class="spnMessageText"><a href="#activeAds">What are active ads?</a></span></li>
                <li><span class="spnMessageText"><a href="#edit">Can I edit my own ads?</a></span></li>
                <li><span class="spnMessageText"><a href="#attach">Can I attach files to my own ads?</a></span></li>
                <li><span class="spnMessageText"><a href="#search">Can I search for any ads?</a></span></li>
                ...
                <li><span class="spnMessageText"><a href="#notify">Can I be notified by e-mail when there are new ads?</a></span></li>
              ...
              <tr>
                <td bgcolor="whitesmoke">
                <p><font face="Verdana, Arial, Helvetica" size="3" color="black">Depending on system settings, registration may not be required to view current ads; however, if you wish to post a new ad or wish to reply to an existing ad, then registration is required. Registration is FREE. It only takes a few seconds. The only required fields are your email address and a login password. Other fields may be necessary in the future in order to group users with common interests.<br /><br />The information you provide during registration is not outsourced or used for any advertising other than displaying your ads. If you believe someone is sending you advertisements as a result of the information you provided through your registration process, please notify us immediately.</font></p></td>
              </tr>
              <tr>
                <td bgcolor="black"><a href="#top"><img src="/images/icon_go_up.gif" width="30" height="30" border="0" alt="Go To Top Of Page" title="Go To Top Of Page" align="right" /></a><a name="popups"></a><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Do I have to enable Popup Windows?</b></font></td>
              </tr>
              <tr>
                <td bgcolor="whitesmoke">
                    <p><font face="Verdana, Arial, Helvetica" size="3" color="black">This system displays some pages using <b>Popup Windows</b>. Some Internet browers intentionally <b>block popup windows</b> to prevent websites to bomb users with excesive advertising via popup windows. In fact, this is a nice and very useful feature available in almost all Internet browsers.</font></p>
                    <p><font face="Verdana, Arial, Helvetica" size="3" color="black">But, we do not practise that form of non-sense advertising in this application. We only display via popup windows pages that you expresely "<b>select and want to read</b>". So, ... in this case it is safe, required and recommended to <b>allow popup windows</b> to display some "specific pages" selected by you from our website.</b></font></p>
                    <p><font face="Verdana, Arial, Helvetica" size="3" color="black">On <b>FireFox</b>, go to "<b>Settings</b>", click on "<b>Privacy and Security</b>", go to "<b>Permissions</b>", and find the "<b>Block Popup Windows</b>" option. Make sure the checkbox in this option is marqued, and then click on <b>Exceptions</b>. There you can add this website's URL ( Ex: <b>http://AspNetPortal.XYZ</b> ) to the list of allowed web sites than can safely send you popup windows. After that, you should be able to see and read any information like alerts, news or bulletins that you expresely click on "<b>Select</b>" in our website.</font></p>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td bgcolor="black"><a href="#top"><img src="/images/icon_go_up.gif" width="30" height="30" border="0" alt="Go To Top Of Page" title="Go To Top Of Page" align="right" /></a><a name="hyperlink"></a><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Creating a Hyperlink in your ads and messages</b></font></td>
              </tr>
              <tr>
                <td bgcolor="whitesmoke"><font face="Verdana, Arial, Helvetica" size="3" color="black">
                <p>You can easily add hyperlinka to your ads and/or messages.</p>
              ...
              <tr>
                <td bgcolor="whitesmoke">
                  <p><font face="Verdana, Arial, Helvetica" size="3" color="black">
                  These 
                      web site uses cookies to store some information like: the last time you logged in, your login name and       your encrypted password, your preferences, etc.  These cookies are stored on your hard drive. Cookies are not used to track your movement or perform any function other than to enhance your use of our web site. If you have not enabled cookies in your browser, many of these time-saving features will not work properly. <b>Also, you need to have cookies enabled if you want to enter an ads or reply to an existing ad.</b></p>
                  <p>You may delete all cookies set by this web site by selecting the red &quot;logoff&quot; button at the top of any page.
                  </font></p></td>
                </tr>
                <tr>
                  <td bgcolor="black"><a href="#top"><img src="/images/icon_go_up.gif" width="30" height="30" border="0" alt="Go To Top Of Page" title="Go To Top Of Page" align="right" /></a><a name="activeAds"></a><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Active Ads</b></font></td>
                </tr>
                <tr>
                  <td bgcolor="whitesmoke">
                  <font face="Verdana, Arial, Helvetica" size="3" color="black">
                  <p>Active Ads are tracked by cookies. When you click on the &quot;active Ads&quot; link, a page is generated listing all ads that have been posted since your last visit to this web site (or approximately 20 minutes ago).</p>
                  </font></td>
                </tr>
                <tr>
                  <td bgcolor="black"><a href="#top"><img src="/images/icon_go_up.gif" width="30" height="30" border="0" alt="Go To Top Of Page" title="Go To Top Of Page" align="right" /></a><a name="edit"></a><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Editing your ads</b></font></td>
                </tr>
                <tr>
                  <td bgcolor="whitesmoke">
                  <p><font face="Verdana, Arial, Helvetica" size="3" color="black">
                ...
                <tr>
                  <td bgcolor="whitesmoke">
                  <p><font face="Verdana, Arial, Helvetica" size="3" color="black">
                  For security reasons, you may not attach files to any ads nor any messages. However, you may cut and paste text into your own ads and messages.</font></p></td>
               </tr>
               <tr>
                 <td bgcolor="black"><a href="#top"><img src="/images/icon_go_up.gif" width="30" height="30" border="0" alt="Go To Top Of Page" title="Go To Top Of Page" align="right" /></a><a name="search"></a><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Searching For Specific Ads</b></font></td>
               </tr>
               <tr>
                 <td bgcolor="whitesmoke">
                 <p><font face="Verdana, Arial, Helvetica" size="3" color="black">
                 You may search for specific ads based on a word or words found in the ad, a user name, a date, and particular regions. Simply click on the &quot;search&quot; link at the top of most pages.</font></p></td>
               </tr>
               <tr>
               ...
               <tr>
                 <td bgcolor="black"><a href="#top"><img src="/images/icon_go_up.gif" width="30" height="30" border="0" alt="Go To Top Of Page" title="Go To Top Of Page" align="right" /></a><a name="censor"></a><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Censoring Ads</b></font></td>
               </tr>
               <tr>
                 <td bgcolor="whitesmoke">
                 <p><font face="Verdana, Arial, Helvetica" size="3" color="black">
               ...
               <tr>
                 <td bgcolor="black"><a href="#top"><img src="/images/icon_go_up.gif" width="30" height="30" border="0" alt="Go To Top Of Page" title="Go To Top Of Page" align="right" /></a><a name="notify"></a><font face="Verdana, Arial, Helvetica" size="3" color="mintcream"><b>Can I be notified by e-mail when there are new ads?</b></font></td>
               </tr>
               <tr>
                 <td bgcolor="whitesmoke">
                 <p><font face="Verdana, Arial, Helvetica" size="3" color="black">
                 Yes, the <b>subscription</b> service allows you to subscribe to the entire site, or you can subscribe to individual regions (Country,State,City), categories, and/or specific ads/bulletins or news. You will receive an e-mail notifying you of new activity that has been posted to the area you have subscribed to. There are four levels of subscription services available in this web site:<br />
                 <blockquote>
                        ...
                        More conveniently, you can subscribe to just any individual ads/bulletins/news. You will be notified of any new activity within that specific item.
                 </blockquote>
               ...
               <tr>
                 <td bgcolor="whitesmoke">
                     ...
                     <p><font face="Verdana, Arial, Helvetica" size="3" color="black">
                         <i>NOTE: Authors of ads or replies will be able to edit their post during this mode.</i></font></p>
