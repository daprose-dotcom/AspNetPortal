<%@ Page Title="Verify Phone Number" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="VerifyPhoneNumber.aspx.vb" Inherits="AspNetPortal.VerifyPhoneNumber" %>
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="Code_Click"
                    Text="Submit" CssClass="redbtn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>