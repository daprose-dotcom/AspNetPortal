...
Partial Public Class ManagePassword
    ...
    End Sub
      ...
      Protected Sub ChangePassword_Click(sender As Object, e As EventArgs)
        If IsValid Then
            ...
            Dim result As IdentityResult = manager.ChangePassword(User.Identity.GetUserId(), CurrentPassword.Text, NewPassword.Text.ToLower)
    ...
    Protected Sub SetPassword_Click(sender As Object, e As EventArgs)
      If IsValid Then
          ...
          Dim manager = Context.GetOwinContext().GetUserManager(Of ApplicationUserManager)()
            Dim result As IdentityResult = manager.AddPassword(User.Identity.GetUserId(), password.Text.ToLower)
            If result.Succeeded Then
