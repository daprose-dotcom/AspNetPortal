<%@ Page Title="Manage Password" Language="vb" MasterPageFile="~/Account/Account.Master" AutoEventWireup="false" CodeBehind="ManagePassword.aspx.vb" Inherits="AspNetPortal.ManagePassword" %>
        ...
        <section id="passwordForm">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" Text="Set Password" ValidationGroup="SetPassword" OnClick="SetPassword_Click" CssClass="redbtn btn-default" />
                        </div>
                    </div>
                </div>
            </asp:PlaceHolder>
            ...
            <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" Text="Change Password" ValidationGroup="ChangePassword" OnClick="ChangePassword_Click" CssClass="redbtn btn-default" />
                        </div>
                    </div>
                    <br />
                </div>
